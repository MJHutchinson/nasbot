 ...
 * Generation date: Thu Jan 24 18:14:33 2019
 * $Revision:$
 * $Date:$
...
/*pyobjfrom*/
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,iidata_Dims,NPY_INT,NULL,(char*)iidata,0,NPY_ARRAY_FARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,ddata_Dims,NPY_DOUBLE,NULL,(char*)ddata,0,NPY_ARRAY_FARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
  ...
  if (cb_fcn_in_direct__user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,2,cdata_Dims,NPY_CHAR,NULL,(char*)cdata,0,NPY_ARRAY_CARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
...
/*frompyobj*/
  ...
  capi_cdata_tmp = array_from_pyobj(NPY_CHAR,cdata_Dims,cdata_Rank,capi_cdata_intent,cdata_capi);
